...
class MainLogger extends \AttachableThreadedLogger {
	 ...
	 * @param string $name
	 */
	public function emergency($message, $name = "KHẨN CẤP"){
	 ...
	 * @param string $name
	 */
	public function alert($message, $name = "BÁO ĐỘNG"){
	 ...
	 * @param string $name
	 */
	public function critical($message, $name = "CHỈ TRÍCH"){
	 ...
	 * @param string $name
	 */
	public function error($message, $name = "LỖI"){
	 ...
	 * @param string $name
	 */
	public function warning($message, $name = "CẢNH BÁO"){
	 ...
	 * @param string $name
	 */
	public function notice($message, $name = "ĐỂ Ý"){
	 ...
	 * @param string $name
	 */
	public function info($message, $name = "THÔNG TIN"){
	 ...
	 * @param string $name
	 */
	public function debug($message, $name = "GỠ LỖI"){
	...
	protected function send($message, $level, $prefix, $color){
		...
		$message = TextFormat::toANSI(TextFormat::AQUA . "[" . date("H:i:s", $now) . "] " . TextFormat::RESET . $color . "[" . $threadName . $color . "/" . $prefix . "]:" . " " . $message . TextFormat::RESET);
		//$message = TextFormat::toANSI(TextFormat::AQUA . "[RapeToLive]->[" . date("H:i:s", $now) . "] " . TextFormat::RESET . $color . "[$prefix]:" . " " . $message . TextFormat::RESET);
