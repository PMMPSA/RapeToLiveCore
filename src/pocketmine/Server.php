...
*  |  __ \             |__   __|  |  ____| (_)          
*  | |__) |__ _ _ __   ___| | ___ | |__  | |___   _____ 
*  |  _  // _` | '_ \ / _ \ |/ _ \|  __| | | \ \ / / _ \
*  | | \ \ (_| | |_) |  __/ | (_) | |    | | |\ V /  __/
*  |_|  \_\__,_| .__/ \___|_|\___/|_|    |_|_| \_/ \___|
*              | |                                      
*              |_|                                      
*
...
class Server{
	...
	public function getiTXApiVersion(){
		return \pocketmine\RTLCORE_API_VERSION;
	}
...
§l§b•»§e   _____               _______    _      _           
§l§b•»§e  |  __ \             |__   __|  | |    (_)          
§l§b•»§e  | |__) |__ _ _ __   ___| | ___ | |     ___   _____ 
§l§b•»§e  |  _  // _` | '_ \ / _ \ |/ _ \| |    | \ \ / / _ \
§l§b•»§e  | | \ \ (_| | |_) |  __/ | (_) | |____| |\ V /  __/
§l§b•»§e  |_|  \_\__,_| .__/ \___|_|\___/|______|_| \_/ \___|
§l§b•»§e              | |                                    
§l§b•»§e              |_|                                    

	§l§b•»§e Phiển Bản Máy Chủ: §6" . $this->getPocketMineVersion() . ' §b(§1R§2a§3n§4d§5o§6m§bOre Version)§f
	§l§b•»§e Phiên Bản Game: §b' . $version . '§f
	§l§b•»§e Phiên Bản PHP: §e' . PHP_VERSION . '§f
	§l§b•»§e Hệ Điều Hành: §6' . PHP_OS .'§f
	§l§b•»§e Core §dRapeToLive§e Được Code Bởi §9PTK-KienPham§6 (https://fb.com/coder.rapetolive)
	§l§b•»§e Nếu Có Thắc Mắc Hoặc Lỗi Gì Xin Báo Lại Cho: §6https://fb.com/coder.rapetolive
	§l§b•»§e Group Về Plugin Và Server PocketMine,GenisysPro,...:https://www.fb.com/groups/289558441476540
	';
	...
	public function __construct(\ClassLoader $autoloader, \ThreadedLogger $logger, $filePath, $dataPath, $pluginPath, $defaultLang = "unknown"){
		...
		try{
			...
			if(file_exists($this->filePath . "src/pocketmine/resources/rtlcore_$lang.yml")){
				$content = file_get_contents($file = $this->filePath . "src/pocketmine/resources/rtlcore_$lang.yml");
			}else{
				$content = file_get_contents($file = $this->filePath . "src/pocketmine/resources/rtlcore_eng.yml");
			}

			if(!file_exists($this->dataPath . "rtlcore.yml")){
				@file_put_contents($this->dataPath . "rtlcore.yml", $content);
			}
			$internelConfig = new Config($file, Config::YAML, []);
			$this->advancedConfig = new Config($this->dataPath . "rtlcore.yml", Config::YAML, []);
			...
			if($cfgVer > $advVer){
				$this->logger->notice("Your rtlcore.yml needs update");
	...
	public function start(){
		...
		if(!file_exists($this->getPluginPath() . DIRECTORY_SEPARATOR . "RapeToLive"))
			@mkdir($this->getPluginPath() . DIRECTORY_SEPARATOR . "RapeToLive");
