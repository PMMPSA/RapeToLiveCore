...
class PureChat extends PluginBase
{
    ...
    */
    ...
    public function onCommand(CommandSender $sender, Command $cmd, $label, array $args)
    {
        switch(strtolower($cmd->getName()))
        {
            case "setformat":
                ...
                if(count($args) < 3)
                {
                    $sender->sendMessage(TextFormat::GREEN . self::MAIN_PREFIX . " Cú pháp: /setformat <nhóm> <thế giới> <format>");
                ...
                if($group === null)
                {
                    $sender->sendMessage(TextFormat::RED . self::MAIN_PREFIX . " Nhóm " . $args[0] . "không tồn tại.");
                ...
                if($args[1] !== "null" and $args[1] !== "global")
                {
                    ...
                    if ($level === null) {
                        $sender->sendMessage(TextFormat::RED . self::MAIN_PREFIX . " Không có world nào như thế");
                ...
                $sender->sendMessage(TextFormat::GREEN . self::MAIN_PREFIX . " Bạn đã setfromat nhóm thành " . $chatFormat . ".");
            ...
            case "setnametag":
                ...
                if(count($args) < 3)
                {
                    $sender->sendMessage(TextFormat::GREEN . self::MAIN_PREFIX . " CÚ pháp: /setnametag <nhóm> <thế giới> <format>");
                ...
                if($args[1] !== "null" and $args[1] !== "global")
                {
                    ...
                    if ($level === null) {
                        $sender->sendMessage(TextFormat::RED . self::MAIN_PREFIX . " world không tồn tại");
                ...
                $sender->sendMessage(TextFormat::GREEN . self::MAIN_PREFIX . " bạn đã set nametag của nhóm thành " . $nameTag . ".");
            ...
            case "setprefix":
                ...
                {
                    $sender->sendMessage(TextFormat::GREEN . self::MAIN_PREFIX . " Lệnh này chỉ có thể dùng trong game");
                ...
                if(!isset($args[0]))
                {
                    $sender->sendMessage(TextFormat::GREEN . self::MAIN_PREFIX . " Cú pháp: /setprefix <prefix>");
                ...
                $sender->sendMessage(TextFormat::GREEN . self::MAIN_PREFIX . " Bạn tự setprefix của mình thành " . $prefix . ".");
            ...
            case "setsuffix":
                ...
                if(!$sender instanceof Player)
                {
                    $sender->sendMessage(TextFormat::GREEN . self::MAIN_PREFIX . " Lệnh này chỉ có thể chạy trong game");
                ...
                if(!isset($args[0]))
                {
                    $sender->sendMessage(TextFormat::GREEN . self::MAIN_PREFIX . " Cú pháp: /setsuffix <suffix>");
                ...
                $sender->sendMessage(TextFormat::GREEN . self::MAIN_PREFIX . " Bạn đã setsuffix của bạn thành " . $suffix . ".");
    ...
    private function loadFactionsPlugin()
    {
        ...
        {
            $this->getLogger()->notice("Không có plugin FactionPro được đánh dáu trong config.yml.Tắt chế độ FactionPro");
        }
        else
        {
            switch(strtolower($factionsPluginName))
            {
                case "factionspro":
                    ...
                    if($factionsPro !== null)
                    {
                        if(version_compare($factionsPro->getDescription()->getVersion(), "0.1#Beta") === -1)
                        {
                            $this->factionsAPI = new FactionsProOld();

                            $this->getLogger()->notice("FactionsPro cũ đã được bật.");
                        ...
                        else
                        {
                            ...
                            $this->getLogger()->notice("FactionsPro mới đã được bật");
                ...
                case "xeviouspe-factions":
                    ...
                    if($this->getServer()->getPluginManager()->getPlugin("XeviousPE-Factions") !== null)
                    {
                        ...
                        $this->getLogger()->notice("XeviousPE-Factions đã được bật");
