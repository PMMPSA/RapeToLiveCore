...
class Main extends PluginBase implements Listener{
	...
	public function onCommand(CommandSender $sender, Command $cmd, $label, array $args){
		if ($cmd->getName() == "trade"){
			$sender->sendMessage(TF::BLUE . "§9[§6Trade§9]§b»  §6Xin hay sử dụng: /trade list để xem danh sách gói vật phẩm, sử dụng /trade doi (tên vật phẩm) để đổi vật phẩm");
			if(isset($args[0])){
				...
				$sender->sendMessage(TF::GREEN . "7.Set Giáp+Kiếm Quý Tộc - 2017 Mắt Thần (cú pháp: set2)");
